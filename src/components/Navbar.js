        ...
        <Toolbar>
          ...
          {isMobile ? (
            ...
            <Stack spacing={{ sm:2, lg: 2 }} direction="row" useFlexGap flexWrap="wrap">
                <Button variant = "contained" sx = {{color: "white", backgroundColor: "black", '&:hover': { backgroundColor: '#555' }}}>GET STARTED</Button>
                <Button variant = "contained" sx = {{color: "white", backgroundColor: "black", '&:hover': { backgroundColor: '#555' }}}>DASHBOARD</Button>
